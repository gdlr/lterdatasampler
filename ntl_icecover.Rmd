...
<figure style="text-align:center;">
  <img src="../man/figures/ntl_icecover_img_3.png" width=60% style="display:block; margin-left: auto; margin-right: auto;">
...
temp_plot_airtemp_anomalies <-
  ...
  geom_bar(stat = "identity", show.legend = FALSE, fill = "chocolate1", color = "chocolate3") +
  theme_minimal() +
  ...
  labs(y = "Standaradized Anomalies", x = NULL)
...
temp_plot_iceduration_anomalies <-
  ...
  geom_bar(stat = "identity", show.legend = FALSE, fill = "lightblue", color = "lightblue3") +
  theme_minimal() +
  # scale_x_date(date_breaks = "year", date_labels = "%b") +
  geom_smooth(
    method = lm,
  ...
  labs(y = "Standaradized Anomalies", x = "Year") 
...
```{r}
plot <- temp_plot_airtemp_anomalies / temp_plot_iceduration_anomalies & theme_void() & plot_annotation(title = "Air Temp and Icecover Anomalies", subtitle = "North Temperate Lakes LTER")

ggsave(plot = plot, filename = "NTL_airtemp.pdf")
```
