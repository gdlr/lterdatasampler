...
knz <- ggplot() +
  ...
  geom_line(data = bison_f_predicted, 
            ...
            size = 1) +
  theme_minimal() +
  theme(plot.background = element_rect(fill = "#576662"),
        panel.grid = element_line(color = "grey50"),
        axis.text = element_text(color = "white"),
        text = element_text(color = "white")) +
  labs(title = "Bison weight as as function of age",
       subtitle = "Konza Prairie LTER",
       x = "Animal Age (years)",
       y = "Animal Weight (kg)")

ggsave(plot = knz, filename = "knz_bison.png", height = 4, width = 7)
